                    ...
                    <div key={faculty.id} className="bg-white rounded-lg shadow-md flex p-4">
                        ...
                        <div className="flex flex-col ml-3">
                            <div className="btn-group-vertical" role="group" aria-label="Vertical button group">
                                <button type="button" className="btn btn-primary" onClick={() => { handle.editBtnPress(faculty.id) }} data-bs-toggle="modal" data-bs-target="#newSubjectModal"><i className="bi bi-pencil" ></i></button>
